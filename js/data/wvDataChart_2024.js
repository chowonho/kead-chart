const chartDataSet = {
    ...
    chart_210: {
        labels: [['적합 인력', '추천'], '모집대행', ['직무분석', '직업영역 개발'], ['현장훈련 후 ', '채용'], '직무체험 등 ', '맞춤훈련', ['장애인', '고용컨설팅']],
        datasets: [
            {
                data: [25.9, 24.7, 22.9, 23.5, 22.3, 22.9, 23.0],
    ...
    chart_211: {
        ...
        datasets: [
            {
                data: [24.6, 22.8, 23.7, 23.3, 23.6, 23.6],
    ...
    chart_212: {
        labels: ['장려금 증액', ['고용에 따른 ', '세금 감면'], '직업영역개발', ['적합 인력 ', '구인서비스 ', '강화'], '부담금 인상'],
        datasets: [
            {
                data: [19.6, 19.2, 12.7, 11.1, 10.7],
    ...
    chart_213: {
        labels: [['적합 직무', '부족'], ['부담금 납부 ', '대상 아님'], ['생산성이 낮을 것 ', '같아서'], '위험한 근무환경'],
        datasets: [
            {
    ...
    chart_306: {
        ...
        datasets: [
            {
                data: [22.3, 14.9, 17.5, 18.6, 27.8, 19.6, 27.9, 25.1],
                backgroundColor: '#082B76',
                borderWidth: 1,
                borderRadius: 5,
            },
    ...
    chart_313: {
        labels: ['돈 벌려고', ['잘 할 수', '있어서'], ['일 배우고', '싶어서'], ['집에만 있기', '싫어서'], ['다른 사람이', '시켜서']],
        datasets: [
            {
        ...
        datasets: [
            ...
            },
            {
                ...
                data: [
                    ...
                    2501112, 2494460, 2490406, 2511051, 2545637, 2585876, 2618918, 2633026, 2644700, 2648424, 2641896,
                ],
                type: 'bar',
                backgroundColor: '#3A6CEB',
                order: 1,
    ...
    chart_403: {
        ...
        datasets: [
            {
                label: '장애인',
                data: [1.3, 2.4, 3.6, 4.2, 7.9, 15.1, 23.8, 21.6, 20.1],
                backgroundColor: '#D64141',
                borderWidth: 1,
                borderRadius: 5,
            },
    ...
    chart_406: {
        ...
        datasets: [
            ...
            {
                data: [1154, 241, 248, 433, 23, 230, 43, 104, 109, 5, 11, 16, 3, 17, 7],
                label: '2023',
                backgroundColor: '#3A6CEB',
                borderWidth: 1,
                borderRadius: 5,
    ...
    chart_408: {
        ...
        datasets: [
            {
                data: [5.8, 4.6, 6.2, 10.3, 17.2, 29.8, 42.1, 49.3, 52.6, 57.4, 59.8, 60.0, 58.8, 53.3],
                label: '13 지체',
                borderColor: '#18BFB1',
                backgroundColor: '#18BFB1',
                type: 'line',
            ...
            {
                data: [13.1, 6.0, 5.5, 5.3, 5.6, 5.3, 5.1, 5.0, 4.9, 5.5, 6.5, 7.1, 8.4, 15.9],
                label: '13 청각',
                borderColor: '#FF5996',
                backgroundColor: '#FF5996',
                type: 'line',
            ...
            {
                data: [24.5, 59.4, 65.0, 67.6, 58.8, 41.0, 24.2, 15.7, 10.7, 6.9, 4.5, 3.2, 1.9, 0.7],
                label: '13 발달',
                borderColor: '#59C8FF',
                backgroundColor: '#59C8FF',
                type: 'line',
            ...
            {
                data: [3.5, 1.7, 3.1, 6.5, 8.8, 12.1, 18.0, 27.6, 38.0, 44.3, 47.0, 51.3, 53.5, 46.8],
                label: '23 지체',
                borderColor: '#18BFB1',
                backgroundColor: '#18BFB1',
                type: 'line',
