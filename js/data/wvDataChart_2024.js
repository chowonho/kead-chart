const chartDataSet = {
    ...
    chart_120: {
        labels: ['일할 의사 있음', '일할 의사 없음', '일할 의사 있음', '일할 의사 없음', '일할 의사 있음', '일할 의사 없음'],
        datasets: [
            {
    ...
    chart_205: {
        labels: [['업무상 필요'], ['고용의무 이행'], ['사업주 지원제도'], ['입사 후 장애인 확인'], ['사회적 이미지 제고']],
        datasets: [
            {
    ...
    chart_207: {
        labels: [['업무능력 갖춘 인력 부족'], ['장애인 지원자가 없음'], ['적합 직무 부족'], ['사업주 등이 소극적'], ['시설 및 편의시설 등 부족']],
        datasets: [
            {
    ...
    chart_210: {
        labels: ['적합 인력 추천', '모집대행', '고용 컨설팅', '현장훈련 후 근로', '직무체험 등', '맞춤훈련', '직무분석, 직업영역 개발'],
        datasets: [
            {
    ...
    chart_304: {
        labels: [['두 단어 이상으로 표현'], ['명확한 단어로 표현'], ['불명료한 단어로 표현'], ['불분명한 소리로 표현'], ['의사 표현이 불가능']],
        datasets: [
            {
