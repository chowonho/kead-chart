    ...
    chart_118 : {
        ...
        data:[
            ...
            },
            {
                a : {text : "전체인구", class:"ac"},
                child : [
                    { A : {text : '정규직' ,class:'ac'}, B : {text :' 136,850,000 '}, C : {text :'61.8'}  },
                    { A : {text : '비정규직' ,class:'ac'}, B : {text :' 84,590,000 '}, C : {text :'38.2'}  },
...
//장애인 비경제활동인구의 향후 일할 의사
    chart_120 : {
        meta : {
            ...
            headers:[
                {title:"구분", colSpan : 2, rowSpan : 3},{title:"인원(명)"},{title:"비율(%)"}
            ]
        },                    
        data:[
            {
    ...
    chart_201 : {
        meta : {            
                ...
                headers:
                        [
                            [
                                {title:"구분", rowSpan : 2},{title:"전체", colSpan : 2},{title:"장애인 고용기업체", colSpan : 2},{title:"장애인미고용기업체", colSpan : 2},{title:"장애인 고용기업체 비율", rowSpan : 2}
                            ],
                            [                     
        ...
        data:[
            { A : {text : '1~4명', class : 'ac'}, B : {text :' 1,447,120 '}, C : {text :'76.0 '}, D : {text :'17,686'}, E : {text :'27.6 '}, F : {text :'1,429,434'}, G : {text :'77.7 '} , H : {text :'1.2 '} },
            { A : {text : '5~49명', class : 'ac'}, B : {text :' 423,575 '}, C : {text :'22.2 '}, D : {text :'22,709'}, E : {text :'35.4 '}, F : {text :'400,866'}, G : {text :'21.8 '} , H : {text :'5.4 '} },
            { A : {text : '50~299명', class : 'ac'}, B : {text :' 30,346 '}, C : {text :'1.6 '}, D : {text :'20,008'}, E : {text :'31.2 '}, F : {text :'10,338'}, G : {text :'0.6 '} , H : {text :'65.9 '} },
            { A : {text : '300~999명', class : 'ac'}, B : {text :' 3,172 '}, C : {text :'0.2 '}, D : {text :'3,063'}, E : {text :'4.8 '}, F : {text :'109'}, G : {text :'0.0 '} , H : {text :'96.6 '} },
            { A : {text : '1,000명 이상', class : 'ac'}, B : {text :' 654 '}, C : {text :'0.0 '}, D : {text :'649'}, E : {text :'1.0 '}, F : {text :'5'}, G : {text :'0.0 '} , H : {text :'99.3 '} },
            { A : {text : '전체', class : 'ac'}, B : {text :' 1,904,866 '}, C : {text :'100.0 '}, D : {text :'64,115'}, E : {text :'100.0 '}, F : {text :'1,840,751'}, G : {text :'100.0 '} , H : {text :'3.4 '} },
     ...
     chart_202 : {
        meta : {            
                ...
                headers:
                        [
                            [
                                {title:"구분", rowSpan:2},{title:"상시근로자", colSpan : 4},{title:"장애인 고용률", rowSpan:2}
                            ],
                            [                     
    ...
    chart_203 : {
     ...
     chart_205 : {
        meta : {            
                ...
                headers:
                        [
                            [
                                {title:"구분", rowSpan:3},{title:"전체(고용)", rowSpan : 3},{title:"고용의무기업체 여부", colSpan:5},{title:"부담금 납부 대상(100명 이상)", rowSpan:3}
                            ],
                            [                     
                                {title : '비의무(5~49명)', rowSpan:2}, {title :'의무', colSpan : 4}
                            ],
                            [
            ...
            data:[
                { A : {text : '고용의무 이행' ,class : 'al'}, B : {text :'31.2 '}, C : {text :'7.4 '}, D : {text :'54.0 '}, E : {text :'52.6 '}, F : {text :'61.0 '}, G : {text :'64.2 '} , H : {text :'57.2 '} },
                { A : {text : '사업주 지원제도',class : 'al'}, B : {text :'9.6 '}, C : {text :'4.3 '}, D : {text :'14.6 '}, E : {text :'15.0 '}, F : {text :'12.7 '}, G : {text :'11.9 '} , H : {text :'15.0 '} },
                { A : {text : '기업의 사회적 이미지 제고',class : 'al'}, B : {text :'5.8 '}, C : {text :'4.5 '}, D : {text :'7.0 '}, E : {text :'7.4 '}, F : {text :'5.5 '}, G : {text :'4.8 '} , H : {text :'7.3 '} },
                { A : {text : '업무상 필요에 의해(장애여부 미고려)',class : 'al'}, B : {text :'47.5 '}, C : {text :'74.8 '}, D : {text :'21.4 '}, E : {text :'22.0 '}, F : {text :'17.8 '}, G : {text :'18.2 '} , H : {text :'18.0 '} },
                { A : {text : '입사 후 장애인임을 확인',class : 'al'}, B : {text :'5.8 '}, C : {text :'9.0 '}, D : {text :'2.7 '}, E : {text :'2.8 '}, F : {text :'2.8 '}, G : {text :'0.9 '} , H : {text :'2.2 '} },
                ...
                { A : {text : '(추정 수)',class : 'ac'}, B : {text :'(46,429)'}, C : {text :'(22,709)'}, D : {text :'(23,720)'}, E : {text :'(20,008)'}, F : {text :'(3,063)'}, G : {text :'(649)'} , H : {text :'(14,635)'} }
     ...
     chart_206 : {
        meta : {            
            ...
            data:[
                    { A : {text : '장애인과 비장애인 구분 없는 일괄채용(일반채용)',class : 'al'}, B : {text :'79.1 '}, C : {text :'85.8 '}, D : {text :'72.6 '}, E : {text :'74.6 '}, F : {text :'62.0 '}, G : {text :'60.6 '} , H : {text :'66.8 '} },
                    { A : {text : '채용계획인원의 일정부분 장애인 할당채용',class : 'al'}, B : {text :'8.8 '}, C : {text :'4.2 '}, D : {text :'13.2 '}, E : {text :'12.4 '}, F : {text :'17.8 '}, G : {text :'17.3 '} , H : {text :'15.8 '} },
                    { A : {text : '장애인만을 대상으로 별도 공개 채용',class : 'al'}, B : {text :'4.4 '}, C : {text :'2.7 '}, D : {text :'6.0 '}, E : {text :'4.9 '}, F : {text :'11.2 '}, G : {text :'12.7 '} , H : {text :'8.2 '} },
                    { A : {text : '장애인의 경우 인사추천을 받아 개별 채용',class : 'al'}, B : {text :'7.7 '}, C : {text :'7.3 '}, D : {text :'8.2 '}, E : {text :'8.1 '}, F : {text :'8.9 '}, G : {text :'9.3 '} , H : {text :'9.1 '} },
                    { A : {text : '전체',class : 'ac'}, B : {text :'100.0 '}, C : {text :'100.0 '}, D : {text :'100.0 '}, E : {text :'100.0 '}, F : {text :'100.0 '}, G : {text :'100.0 '} , H : {text :'100.0 '} },
                    { A : {text : '(추정 수)',class : 'ac'}, B : {text :'(46,429)'}, C : {text :'(22,709)'}, D : {text :'(23,720)'}, E : {text :'(20,008)'}, F : {text :'(3,063)'}, G : {text :'(649)'} , H : {text :'(14,635)'} }
            ]
    } ,
     ...
     chart_207 : {
        meta : {            
            ...
            data:[
                { A : {text : '업무능력을 갖춘 인력이 부족해서',class : 'al'}, B : {text :'16.5 '}, C : {text :'9.8 '}, D : {text :'23.0 '}, E : {text :'22.6 '}, F : {text :'24.8 '}, G : {text :'25.9 '} , H : {text :'26.8 '} },
                { A : {text : '장애인 지원자 자체가 없어서',class : 'al'}, B : {text :'12.7 '}, C : {text :'5.8 '}, D : {text :'19.4 '}, E : {text :'19.4 '}, F : {text :'18.6 '}, G : {text :'22.4 '} , H : {text :'16.4 '} },
                { A : {text : '장애인에게 적합한 직무가 부족하거나 찾지 못해서',class : 'al'}, B : {text :'10.1 '}, C : {text :'7.3 '}, D : {text :'12.7 '}, E : {text :'11.7 '}, F : {text :'18.2 '}, G : {text :'15.4 '} , H : {text :'15.0 '} },
                { A : {text : '사업주, 관맂, 동료 등이 채용에 대해 소극적',class : 'al'}, B : {text :'1.5 '}, C : {text :'0.5 '}, D : {text :'2.5 '}, E : {text :'2.5 '}, F : {text :'3.1 '}, G : {text :'0.7 '} , H : {text :'3.1 '} },
                { A : {text : '장애인용 시설 및 장비·편의시설 등이 부족해서',class : 'al'}, B : {text :'1.5 '}, C : {text :'0.5 '}, D : {text :'2.3 '}, E : {text :'2.5 '}, F : {text :'1.3 '}, G : {text :'1.8 '} , H : {text :'2.2 '} },
                { A : {text : '전체',class : 'ac'}, B : {text :'100.0 '}, C : {text :'100.0 '}, D : {text :'100.0 '}, E : {text :'100.0 '}, F : {text :'100.0 '}, G : {text :'100.0 '} , H : {text :'100.0 '} },
                { A : {text : '(추정 수)',class : 'ac'}, B : {text :'(46,429)'}, C : {text :'(22,709)'}, D : {text :'(23,720)'}, E : {text :'(20,008)'}, F : {text :'(3,063)'}, G : {text :'(649)'} , H : {text :'(14,635)'} }
            ]
    } ,
     ...
     chart_208 : {
        meta : {            
            ...
            data:[
                { A : {text : '대부분 업무에서 중증장애인이 수행할 직무가 있다',class : 'al'}, B : {text :'8.7 '}, C : {text :'6.0 '}, D : {text :'11.2 '}, E : {text :'11.8 '}, F : {text :'8.4 '}, G : {text :'7.1 '} , H : {text :'11.1 '} },
                { A : {text : '제한적인 업무에서 중증장애인이 수행할 직무가 있다',class : 'al'}, B : {text :'28.7 '}, C : {text :'17.0 '}, D : {text :'39.9 '}, E : {text :'38.0 '}, F : {text :'48.6 '}, G : {text :'56.5 '} , H : {text :'46.0 '} },
                { A : {text : '중증장애인이 수행할 만한 직무를 찾기 힘들다',class : 'al'}, B : {text :'62.6 '}, C : {text :'77.0 '}, D : {text :'48.9 '}, E : {text :'50.2 '}, F : {text :'42.9 '}, G : {text :'36.4 '} , H : {text :'42.9 '} },
                { A : {text : '전체',class : 'ac'}, B : {text :'100.0 '}, C : {text :'100.0 '}, D : {text :'100.0 '}, E : {text :'100.0 '}, F : {text :'100.0 '}, G : {text :'100.0 '} , H : {text :'100.0 '} },
                { A : {text : '(추정 수)', class : 'ac'}, B : {text :'(46,429)'}, C : {text :'(22,709)'}, D : {text :'(23,720)'}, E : {text :'(20,008)'}, F : {text :'(3,063)'}, G : {text :'(649)'} , H : {text :'(14,635)'} }
            ]
    } ,
//장애인 수행가능 직무가 있는 비율
     chart_209 : {
         meta : {            
            ...
            data:[
                    { A : {text : '대부분 업무에서 중증장애인이 수행할 직무가 있다', class : 'al'}, B : {text :'0.6 '} },
                    { A : {text : '제한적인 업무에서 중증장애인이 수행할 직무가 있다', class : 'al'}, B : {text :'30.2 '} },
                    { A : {text : '중증장애인이 수행할 만한 직무를 찾기 힘들다', class : 'al'}, B : {text :'29.2 '} },
...
chart_210 : {
    meta : {            
               ...
               headers:
                       [
                           [{title:"구분", rowSpan : 2},{title:"전체\r\n(고용+미고용)", rowSpan : 2},{title:"장애인고용 여부", colSpan : 2}],
                           [{title:"고용"},{title:"미고용"}]
                       ]
            },  
       data:[
                { A : {text : '적합한 인력 추천', class : 'al'}, B : {text :'25.9 '}, C : {text :'37.8 '} , D : {text :'24.6 '} },
                { A : {text : '모집대행 서비스', class : 'al'}, B : {text :'24.7 '}, C : {text :'33.8 '} , D : {text :'23.7 '} },
                { A : {text : '직무분석, 기업체 내 장애인 직업영역 개발', class : 'al'}, B : {text :'22.9 '}, C : {text :'28.6 '} , D : {text :'22.2 '} },
                { A : {text : '사전 현장훈련 후 근로', class : 'al'}, B : {text :'23.5 '}, C : {text :'28.3 '} , D : {text :'22.9 '} },
                { A : {text : '직무체험 등 적합장애인 탐색기회 제공', class : 'al'}, B : {text :'22.3 '}, C : {text :'27.9 '} , D : {text :'21.7 '} },
                { A : {text : '맞춤훈련', class : 'al'}, B : {text :'22.9 '}, C : {text :'28.4 '} , D : {text :'22.3 '} },
                { A : {text : '장애인 고용 컨설팅', class : 'al'}, B : {text :'23.0 '}, C : {text :'30.7 '} , D : {text :'22.1 '} },
   ...
   chart_211 : {
    meta : {            
            ...
            headers:
                    [
                        [{title:"구분", rowSpan : 2},{title:"전체 (고용+미고용)", rowSpan : 2},{title:"장애인고용 여부", colSpan : 2}],
                        [{title:"고용"},{title:"미고용"}]
                    ]
            },  
       data:[
                { A : {text : '직무능력향상훈련', class : 'al'}, B : {text :'24.6 '}, C : {text :'30.9 '} , D : {text :'23.8 '} },
                { A : {text : '장애인 지원 전문인력', class : 'al'}, B : {text :'22.8 '}, C : {text :'29.2 '} , D : {text :'22.1 '} },
                { A : {text : '편의시설 진단 서비스', class : 'al'}, B : {text :'23.7 '}, C : {text :'27.4 '} , D : {text :'23.3 '} },
                { A : {text : '작업보조기기 무상지원', class : 'al'}, B : {text :'23.3 '}, C : {text :'25.6 '} , D : {text :'23.1 '} },
                { A : {text : '출퇴근 지원', class : 'al'}, B : {text :'23.6 '}, C : {text :'25.9 '} , D : {text :'23.4 '} },
                { A : {text : '직업생활, 고충처리 상담인력 및 비용지원', class : 'al'}, B : {text :'23.6 '}, C : {text :'26.8 '} , D : {text :'23.2 '} },
                { A : {text : '(추정 수)', class : 'ac'}, B : {text :'(457,746)'}, C : {text :'(46,429)'} , D : {text :'(411,317)'} }        
           ]
   } ,
   ...
   chart_214 : {
    meta : {            
            ...
            headers:
                    [
                        [{title:"구분", rowSpan : 2},{title:"전체 (고용)", rowSpan : 2},{title:"고용의무기업체 여부", colSpan : 3}],
...
chart_302: {
    meta : {            
            ...
            headers:
                    [                       
                        {title:"구분", colSpan : 2},{title:"추정수(명)"},{title:"비율(%)"}
                    ]
            },  
    data:[
            {
...
chart_305: {
    ...
    data:[
        ...
        {
            a : {text : "전체", class:"ac", colSpan : 2}, b : {text : "219,000", class:"ac"}, c : {text : "100.0", class:"ac"}
        }
...
{ A : {text : '받고 있지 않으며 필요하지 않음', class : 'al'}, B : {text :' 11,743 '}, C : {text :' 18.0 '} },
        ...
        {
            a : {text : "전체", class:"ac", colSpan : 2}, b : {text : "65,144", class:"ac"}, c : {text : "100.0", class:"ac"}
        }
...
chart_401: {
    meta : {            
            ...
            headers:
                    [                       
                        {title:"구분"},{title:"등록장애인 수"},{title:"등록장애인 비율"},{title:"전체인구 수"}
                    ]
            },  
    data:[
...
chart_402: {
    meta : {            
            ...
            headers:
                    [                       
                        {title:"구분"},{title:"남성"},{title:"여성"},{title:"여성비율(%)"}
                    ]
            },  
    data:[
...
chart_403: {
    meta : {            
            ...
            headers:
                    [                       
                        {title:"구분"},{title:"장애인"},{title:"장애인 비율"},{title:"전체인구"},{title:"전체인구 비율"}
                    ]
            },  
        data:[
...
chart_404: {
    meta : {            
            ...
            headers:
                    [                       
                        {title:"구분", colSpan : 2},{title:"2013"},{title:"2018"},{title:"2023"}
                    ]
            },  
        data:[
            {
...
chart_405: {
    meta : {            
            ...
            headers:
                    [                       
                        {title:"구분"},{title:"전체"},{title:"15~64세"},{title:"65세 이상"}
                    ]
            },  
    data:[
...
chart_406: {
    meta : {            
            ...
            headers:
                    [                       
                        {title:"구분"},{title:"2013"},{title:"2018"},{title:"2023"}
                    ]
            },  
    data:[
...
chart_407: {
    meta : {            
            ...
            headers:
                    [                       
                        {title:"구분"},{title:"심한장애"},{title:"심하지않은장애"},{title:"심한장애 비중(%)"}
                    ]
            },  
    data:[
...
chart_408: {
    meta : {            
            ...
            headers:
                    [                       
                        {title:"구분"},{title:"2013 합계"},{title:"2013 지체"},{title:"13 지체 비율"},{title:"2013 청각"},{title:"13 청각 비율"},{title:"2013 발달"},{title:"13 발달 비율"},{title:"2023 합계"},{title:"2023 지체"},{title:"23 지체 비율"},{title:"2023 청각"},{title:"23 청각 비율"},{title:"2023 발달"},{title:"23 발달 비율"}
                        													

                    ]
            },  
    data:[
            { A : {text : '0-4세', class : 'ac'}, B : {text :' 5,011 '}, C : {text :' 290 '}, D : {text :' 5.8 '}, E : {text :' 655 '}, F : {text :' 13.1 '}, G : {text :' 11.6 '}, H : {text :' 24.5 '}, I : {text :' 4,589 '}, J : {text :' 162 '}, K : {text :' 3.5 '}, L : {text :' 534 '}, M : {text :' 11.6 '}, N : {text :' 1,315 '}  , O : {text :'28.7'} },
            { A : {text : '5-9세', class : 'ac'}, B : {text :' 17,673 '}, C : {text :' 805 '}, D : {text :' 4.6 '}, E : {text :' 1,068 '}, F : {text :' 6.0 '}, G : {text :' 3.3 '}, H : {text :' 59.4 '}, I : {text :' 30,591 '}, J : {text :' 505 '}, K : {text :' 1.7 '}, L : {text :' 1,000 '}, M : {text :' 3.3 '}, N : {text :' 21,911 '}  , O : {text :'71.6'} },
            { A : {text : '10-14세', class : 'ac'}, B : {text :' 28,990 '}, C : {text :' 1,791 '}, D : {text :' 6.2 '}, E : {text :' 1,592 '}, F : {text :' 5.5 '}, G : {text :' 3.7 '}, H : {text :' 65.0 '}, I : {text :' 32,318 '}, J : {text :' 1,016 '}, K : {text :' 3.1 '}, L : {text :' 1,201 '}, M : {text :' 3.7 '}, N : {text :' 25,526 '}  , O : {text :'79'} },
            { A : {text : '15-19세', class : 'ac'}, B : {text :' 40,095 '}, C : {text :' 4,127 '}, D : {text :' 10.3 '}, E : {text :' 2,144 '}, F : {text :' 5.3 '}, G : {text :' 4.1 '}, H : {text :' 67.6 '}, I : {text :' 31,488 '}, J : {text :' 2,042 '}, K : {text :' 6.5 '}, L : {text :' 1,293 '}, M : {text :' 4.1 '}, N : {text :' 23,460 '}  , O : {text :'74.5'} },
            { A : {text : '20-24세', class : 'ac'}, B : {text :' 42,496 '}, C : {text :' 7,324 '}, D : {text :' 17.2 '}, E : {text :' 2,382 '}, F : {text :' 5.6 '}, G : {text :' 4.4 '}, H : {text :' 58.8 '}, I : {text :' 42,243 '}, J : {text :' 3,727 '}, K : {text :' 8.8 '}, L : {text :' 1,851 '}, M : {text :' 4.4 '}, N : {text :' 29,153 '}  , O : {text :'69'} },
            { A : {text : '25-29세', class : 'ac'}, B : {text :' 46,513 '}, C : {text :' 13,847 '}, D : {text :' 29.8 '}, E : {text :' 2,468 '}, F : {text :' 5.3 '}, G : {text :' 4.9 '}, H : {text :' 41.0 '}, I : {text :' 51,912 '}, J : {text :' 6,288 '}, K : {text :' 12.1 '}, L : {text :' 2,531 '}, M : {text :' 4.9 '}, N : {text :' 32,426 '}  , O : {text :'62.5'} },
            { A : {text : '30-34세', class : 'ac'}, B : {text :' 76,617 '}, C : {text :' 32,279 '}, D : {text :' 42.1 '}, E : {text :' 3,944 '}, F : {text :' 5.1 '}, G : {text :' 5.3 '}, H : {text :' 24.2 '}, I : {text :' 52,468 '}, J : {text :' 9,441 '}, K : {text :' 18.0 '}, L : {text :' 2,757 '}, M : {text :' 5.3 '}, N : {text :' 26,416 '}  , O : {text :'50.3'} },
            { A : {text : '35-39세', class : 'ac'}, B : {text :' 98,882 '}, C : {text :' 48,766 '}, D : {text :' 49.3 '}, E : {text :' 4,945 '}, F : {text :' 5.0 '}, G : {text :' 5.2 '}, H : {text :' 15.7 '}, I : {text :' 57,208 '}, J : {text :' 15,776 '}, K : {text :' 27.6 '}, L : {text :' 2,976 '}, M : {text :' 5.2 '}, N : {text :' 19,960 '}  , O : {text :'34.9'} },
            { A : {text : '40-44세', class : 'ac'}, B : {text :' 145,437 '}, C : {text :' 76,501 '}, D : {text :' 52.6 '}, E : {text :' 7,183 '}, F : {text :' 4.9 '}, G : {text :' 5.1 '}, H : {text :' 10.7 '}, I : {text :' 92,260 '}, J : {text :' 35,023 '}, K : {text :' 38.0 '}, L : {text :' 4,696 '}, M : {text :' 5.1 '}, N : {text :' 19,701 '}  , O : {text :'21.4'} },
            { A : {text : '45-49세', class : 'ac'}, B : {text :' 191,741 '}, C : {text :' 110,111 '}, D : {text :' 57.4 '}, E : {text :' 10,624 '}, F : {text :' 5.5 '}, G : {text :' 5.2 '}, H : {text :' 6.9 '}, I : {text :' 117,515 '}, J : {text :' 52,011 '}, K : {text :' 44.3 '}, L : {text :' 6,103 '}, M : {text :' 5.2 '}, N : {text :' 16,416 '}  , O : {text :'14'} },
            { A : {text : '50-54세', class : 'ac'}, B : {text :' 263,590 '}, C : {text :' 157,709 '}, D : {text :' 59.8 '}, E : {text :' 17,048 '}, F : {text :' 6.5 '}, G : {text :' 5.5 '}, H : {text :' 4.5 '}, I : {text :' 172,916 '}, J : {text :' 81,262 '}, K : {text :' 47.0 '}, L : {text :' 9,518 '}, M : {text :' 5.5 '}, N : {text :' 16,200 '}  , O : {text :'9.4'} },
            { A : {text : '55-59세', class : 'ac'}, B : {text :' 279,522 '}, C : {text :' 167,596 '}, D : {text :' 60.0 '}, E : {text :' 19,885 '}, F : {text :' 7.1 '}, G : {text :' 6.9 '}, H : {text :' 3.2 '}, I : {text :' 224,800 '}, J : {text :' 115,382 '}, K : {text :' 51.3 '}, L : {text :' 15,474 '}, M : {text :' 6.9 '}, N : {text :' 13,611 '}  , O : {text :'6.1'} },
            { A : {text : '60-64세', class : 'ac'}, B : {text :' 254,673 '}, C : {text :' 149,704 '}, D : {text :' 58.8 '}, E : {text :' 21,414 '}, F : {text :' 8.4 '}, G : {text :' 9.3 '}, H : {text :' 1.9 '}, I : {text :' 306,493 '}, J : {text :' 164,105 '}, K : {text :' 53.5 '}, L : {text :' 28,420 '}, M : {text :' 9.3 '}, N : {text :' 11,686 '}  , O : {text :'3.8'} },
            { A : {text : '65세 이상', class : 'ac'}, B : {text :' 1,009,721 '}, C : {text :' 538,435 '}, D : {text :' 53.3 '}, E : {text :' 160,047 '}, F : {text :' 15.9 '}, G : {text :' 24.9 '}, H : {text :' 0.7 '}, I : {text :' 1,425,095 '}, J : {text :' 666,761 '}, K : {text :' 46.8 '}, L : {text :' 354,500 '}, M : {text :' 24.9 '}, N : {text :' 14,743 '}  , O : {text :'1'} }
